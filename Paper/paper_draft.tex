...
Several caveats apply. First, the analysis is limited to 2010-2017 when fintech data are available, and the fintech market has evolved substantially since then. Second, the CAPS sample of low-to-moderate income homeowners may not generalize to the broader population. Third, I observe fintech mortgage market share but cannot directly measure fintech small business lending, which would be more directly relevant for self-employment decisions.

Despite these limitations, the findings have important implications. For policymakers concerned about the effects of banking consolidation on underserved communities, fintech lending appears to provide a partial market-based solution. However, the mitigation is incomplete---even at high fintech penetration, closure effects are not fully offset.

This suggests a role for policy interventions that facilitate alternative lending while maintaining consumer protections. The CFPB's Section 1033 open banking rule, which requires data sharing to enhance competition, may help in this regard by allowing fintech lenders to better assess borrowers' creditworthiness. Community development financial institutions (CDFIs) and credit unions may also help fill gaps that remain after both traditional bank and fintech channels are exhausted.

For the fintech industry, these results support claims that alternative lenders serve borrowers underserved by traditional banks. At the same time, the findings highlight that fintech lending is not a panacea---significant negative effects of closure remain even in high-fintech areas.

Future research should examine whether these patterns persist as fintech lending matures and expands into small business credit. Understanding the types of borrowers and businesses most affected by both closures and fintech availability would help target policy interventions more effectively.
