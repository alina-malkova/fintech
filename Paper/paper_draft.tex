...
Future research should address identification more directly. First, instrumental variables could exploit pre-period broadband infrastructure (e.g., 2005--2008 FCC Form 477 data) as an instrument for later fintech adoption: areas with better early broadband infrastructure adopted fintech faster, but early broadband is unlikely to directly affect self-employment transitions five to ten years later conditional on fixed effects. Second, better fintech measurement could use CRA small business lending data to classify fintech small business lenders directly, rather than relying on mortgage fintech as a proxy. Third, PPP loan data from 2020--2021 identifies fintech lenders explicitly and could serve as an out-of-sample validation: do counties where fintech mitigated closure effects in 2010--2014 also show higher fintech PPP uptake in 2020? Finally, extending the analysis to other individual-level panels (SIPP, PSID) that extend beyond 2014 would test generalizability beyond the CAPS sample. Understanding whether and how fintech expands credit access remains an important open question.
