...
\begin{tablenotes}
\small
\item \textit{Notes:} Dependent variable is indicator for transitioning to incorporated self-employment. Standard errors clustered by county in parentheses. Banking desert specification omitted due to collinearity with individual FE (insufficient within-group variation). * p<0.10, ** p<0.05, *** p<0.01.
\end{tablenotes}
\end{threeparttable}
\end{table}
