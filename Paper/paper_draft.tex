...
\midrule
Drop Merger 1 & 0.8224** & (0.3617) & 484 \\
...
Drop Merger 7 & 0.8224** & (0.3617) & 484 \\
...
\midrule
\multicolumn{4}{l}{\textit{Range: 0.56--0.96}} \\
\bottomrule
\end{tabular}
\begin{tablenotes}
\small
...
The pattern of results---significant in the baseline, attenuated but positive with county FE, no pre-trend in the placebo, and robust to leave-one-out analysis (coefficients range 0.56--0.96 across all merger groups)---is consistent with fintech providing some mitigation, though the magnitude is uncertain. The most conservative interpretation is that the true effect lies between zero and the baseline estimate of 0.82, with considerable uncertainty.
